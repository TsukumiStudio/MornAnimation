...
namespace MornLib
{
	internal sealed class MornAnimationTransform : MornAnimationTargetBase
	{
		...
		[SerializeField, ShowIf(nameof(_moveEnabled))] private MornAnimationMoveModule _moveModule = new();
		[SerializeField] private bool _moveUGUIEnabled;
		[SerializeField, ShowIf(nameof(_moveUGUIEnabled))] private MornAnimationMoveUGUIModule _moveUGUIModule = new();
		[SerializeField] private bool _rotateEnabled;
		[SerializeField, ShowIf(nameof(_rotateEnabled))] private MornAnimationRotateModule _rotateModule = new();
		[SerializeField] private bool _scaleEnabled;
		[SerializeField, ShowIf(nameof(_scaleEnabled))] private MornAnimationScaleModule _scaleModule = new();
